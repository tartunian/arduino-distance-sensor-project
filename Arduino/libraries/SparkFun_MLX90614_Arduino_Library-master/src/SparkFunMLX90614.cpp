...
int16_t IRTherm::readPWMConfig(void) {
	int16_t tempValue;
	if(I2CReadWord(MLX90614_REGISTER_PWMCTRL, &tempValue)) {
		return tempValue;
	}
	return 0;
}

uint16_t IRTherm::setPWMConfig(int16_t value) {
	return writeEEPROM(MLX90614_REGISTER_PWMCTRL, value);
}
