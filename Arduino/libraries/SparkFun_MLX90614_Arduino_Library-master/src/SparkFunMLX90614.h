...
public:
	...
	// methods to read and write the PWM control register
	int16_t readPWMConfig(void);
	uint16_t setPWMConfig(int16_t value);

	// methods to read and write the config register
	int16_t readConfig(void);
	uint16_t setConfig(int16_t value);
